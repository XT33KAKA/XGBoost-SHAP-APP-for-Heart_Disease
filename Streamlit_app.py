...
if st.button("Predict"):
    ...
    if predicted_class == 1:
        ...
        f"The model predicts a probability of {probability:.1f}% for having heart disease. "
        "This is an estimate, and it indicates that you may be at significant risk. "
        "It is recommended that you consult a cardiologist as soon as possible for further evaluation "
        "and to receive an accurate diagnosis and necessary treatment."
    )
    else:
        advice = (
        f"According to our model, you have a low risk of heart disease. "
        f"The model predicts a probability of {probability:.1f}% for not having heart disease. "
        "Maintaining a healthy lifestyle is still crucial. "
        "Regular check-ups are recommended to monitor your heart health, "
        "and you should seek medical advice promptly if you experience any symptoms."
    )
